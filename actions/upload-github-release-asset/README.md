...
- name: Upload release assets
  uses: TRI-Actions/custom-actions/actions/upload-release-asset@main
  with:
    tag: v1.0.0
    files: dist/*.tgz
```
...
- [`actions/upload-release-asset`](https://github.com/actions/upload-release-asset) - Official but deprecated
